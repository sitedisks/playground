...
class BestongSpider(Spider):
    ...
    categories = {
        ...
        '15': 'Adult Services',
        '50': 'Hairdresser',
        '63': 'Restaurant Equipments',
        '64': 'Traditional Chinese Therapy',
        '65': 'Traditional Chinese Medicine'
    }

    def __init__(self, city='Sydney', category='4', *args, **kwargs):
    ...
    def parse(self, response):
        ...
        try:
            ...
            #     '//div[contains(@class, "outside_1")]')
            business_name = response.css('.company_name')

            for business in business_name:
                name = business.css('.company_name a::text').get().strip()
                ...
                url = business.css('.company_name a::attr(href)').get()
    ...
    def parse_details(self, response):
        ...
        try:
            ...
            item['business_address'] = find_between(
